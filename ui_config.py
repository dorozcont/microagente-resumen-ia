...
from config import (
    ...
    INPUT_LINES, OUTPUT_LINES, TRANSLATION_MODEL_NAME
)
...
def create_system_info_card(device, model_name, translation_model_name):
    """Crea la tarjeta de información del sistema"""
    return create_cyber_card(
        content=f"""
